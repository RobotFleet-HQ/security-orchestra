...
app.use((_req: express.Request, res: express.Response, next: express.NextFunction) => {
  ...
  res.setHeader(
    ...
    "default-src 'self'; script-src 'self' 'unsafe-inline' https://www.googletagmanager.com https://www.google-analytics.com; style-src 'self' 'unsafe-inline'; img-src 'self' data: https://www.google-analytics.com; connect-src 'self' https://www.google-analytics.com https://security-orchestra-orchestrator.onrender.com https://security-orchestra-billing.onrender.com; frame-ancestors 'none'"
  );
  next();
});
